...
class ArticleSeeder extends Seeder
{
     ...
     * switching that page over to a DB-backed list doesn't lose any
     * existing content.
     */
    public function run(): void
    {
        ...
        $articles = [
            ...
            [
                ...
                'cta_text' => 'Need equipment rental support tailored to your project?',
                'cta_label' => 'Request a Service Inquiry',
                'cta_route' => 'public.contact',
            ],
            [
                ...
                'cta_text' => 'Want to coordinate equipment support or planning services with YellowQuip?',
            ...
            [
                ...
                'cta_text' => 'Interested in ISO-aligned equipment services or operational support?',
                'cta_label' => 'Inquire With Us',
                'cta_route' => 'public.contact',
            ],
            [
                ...
                'cta_text' => 'Authorized users may access controlled SOP documents through the Member Portal. For business and service inquiries, contact the YellowQuip team.',
            ...
            [
                ...
                'cta_text' => 'Want to work with a team that values safety, quality, and people?',
                'cta_label' => 'Connect With YellowQuip',
                'cta_route' => 'public.contact',
            ],
            [
                ...
                'cta_text' => 'Need reliable rental support for your next project?',
                'cta_label' => 'Request Equipment Support',
                'cta_route' => 'public.contact',
            ],
            [
                ...
                'cta_text' => "See YellowQuip's work in action or inquire about a service.",
                'cta_label' => 'View Project Gallery',
                'cta_route' => 'public.project-gallery',
            ],
        ];
        ...
        foreach ($articles as $i => $article) {
            Article::create([
                'title' => $article['title'],
                'slug' => Article::uniqueSlugFrom($article['title']),
                'category' => $article['category'],
                'image_path' => $this->copySeedImage('articles', $article['image']),
                'excerpt' => $article['excerpt'],
                'content' => $this->paragraphsToHtml($article['content']),
                'note' => $article['note'] ?? null,
                'cta_text' => $article['cta_text'] ?? null,
                'cta_label' => $article['cta_label'] ?? null,
                'cta_url' => route($article['cta_route']),
                'status' => 'published',
