...
<form method="POST" action="{{ route('admin.content-articles.store') }}" enctype="multipart/form-data" class="form-card">
    @csrf

    <label for="title">Title</label>
    <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="e.g. ISO Implementations at YellowQuip">

    <label for="category">Category <span class="muted">(optional)</span></label>
    <input type="text" id="category" name="category" value="{{ old('category') }}" placeholder="e.g. ISO and Compliance">
